...
export default function SummaryTab({ taskId, readOnly }: SummaryTabProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-medium">
              {t("evolution.evolveAnnotation.summaryTitle")}
            </h3>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto space-y-3">
          ...
          {data.block_summary && (
            <Card className="p-3">
              ...
              <p className="text-sm leading-relaxed">{data.block_summary}</p>
            </Card>
          )}
