...
from llm4ad.task.optimization.online_bin_packing_fm.template import template_program, task_description
from llm4ad.task.optimization.online_bin_packing_fm.generate_weibull_instances_fm import generate_weibull_dataset_fm
import pickle as pkl

__all__ = ['OBPFMEvaluation']


class OBPFMEvaluation(Evaluation):
    ...
    def __init__(self, timeout_seconds=30,
        ...
        #self._datasets = generate_weibull_dataset_fm(self.n_instances, self.n_items, self.capacity)
        self._datasets = pkl.load(open('./dataset.pkl', 'rb'))
